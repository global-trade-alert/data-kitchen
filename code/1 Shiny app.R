  ...
  fluidRow(
    ...
    column(6,
           ...
           multiInput("eligible.firms.data.count",
                      ...
                      c('any', 'all', 'firm-specific', 'SMEs', 'state-controlled','state trading enterprise','location-specific'),
                      selected = "any"),
                   ...
                   fluidRow(
                     column(6,
                            ...
                            selectInput("line.colour.data.count",
                                        ...
                                        multiple = F,
                                        selected = "gta_colour$qualitative")),
                     column(6,
